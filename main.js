...
const updateHeaderTitle=s=>{const titles={'dashboard':'Dashboard','overview':'Dashboard','performance':'Dashboard','activity-log':'Dashboard'},mainSections={'overview':'dashboard','performance':'dashboard','activity-log':'dashboard'},m=mainSections[s]||s,el=document.getElementById('currentSectionSidebar');if(el)el.textContent=titles[m]||'Dashboard';document.querySelectorAll('.dropdown-item').forEach(i=>i.classList.toggle('active',i.getAttribute('data-section')===m));updateSubNavigation(m)}
